    ...
    <div class="layui-tab layui-tab-card">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form layui-input-form" action="yonghuupdate.do" method="post" name="form1"
                      id="form1">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <select class="layui-select class_xingbie5" data-value="${Info.html(mmm.xingbie)}"
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="layui-input-group" style="width:250px">
                                <input type="text" class="layui-input" data-rule-required="true"
                                       data-msg-required="请填写头像" id="touxiang" name="touxiang"
