...
var Menu = function(options){
	this.cacheOpen = {};
	this.nav = options.nav || $('#bd .nav');
	this.tab = options.tab || $('#bd .tab');
	this.content = options.content || $('#bd .content');
...
Menu.prototype._createContent = function($this){
	...
	var $iframe= $('<iframe data-id="'+ id +'" width="100%" height="100%" style="width:100%;" frameborder="0" src="'+ href +'"></iframe>');
