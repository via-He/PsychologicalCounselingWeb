...
<div class="layui-tab layui-tab-card">
    ...
    <div class="layui-tab-content">
        ...
        预约类型
                                ...
                                <select class="layui-select class_yuyueleixing24" data-value="${param.yuyueleixing}" id="yuyueleixing" name="yuyueleixing">
<option value="">请选择</option><option value="在线沟通">在线沟通</option>
<option value="线下沟通">线下沟通</option>

</select>
<script>
$(".class_yuyueleixing24").val($(".class_yuyueleixing24").attr("data-value"))</script>
