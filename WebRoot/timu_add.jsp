...
<div class="layui-tab layui-tab-card">
    <ul class="layui-tab-title">
        <li class="layui-this">题目添加题目:</li>
    </ul>
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form class="layui-form layui-input-form" action="timuinsert.do" method="post" name="form1" id="form1">
    ...
    <div class="layui-input-block">
                                                    ...
                                                    <input type="text" class="layui-input" placeholder="输入编号" style="width:150px;" readonly="readonly" id="bianhao" name="bianhao" value="${Info.getID()}"/>                                            
    </div>
</div>
                                                        <div class="layui-form-item">
    ...
    <div class="layui-input-block">
                                                    ...
                                                    <textarea style="width:80%;height:150px;max-width: 90%;min-height: 120px" class="layui-textarea" placeholder="输入题目" id="timu" name="timu"></textarea>                                            
    </div>
</div>
                                                        <div class="layui-form-item">
    ...
    <div class="layui-input-block">
                                                    ...
                                                    <select class="layui-select class_leixing10" data-value="" id="leixing" name="leixing" style="width:250px">
