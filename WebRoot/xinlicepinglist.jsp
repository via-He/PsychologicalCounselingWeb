...
<form action="?" class="search">
            ...
            <tbody>
                ...
                <td>
                    ...
                    <input type="text" class="layui-input" style="width: 150px" name="cepingzhuti" value="${param.cepingzhuti}" placeholder="请输入关键词"/>
    ...
    搜索
            ...
            <div class="snock col-md-3">
                <a href="xinlicepingdetail.do?id=${r.id}">
                    <div class="services">
                        <div class="img-box snocks pb100">
                            <div class="img" style="background-image: url('${r.tupian}')"></div>
                        </div>
                        <h2>${Info.subStr(r.cepingzhuti, 15)}</h2>
                        <p>${Info.subStr(r.cepingjieshao, 60)}</p>
                    </div>
                </a>
            </div>
            </c:forEach>
