...
<th lay-data="{field:'qifenshu'}"> 起分数  </th>
<th lay-data="{field:'zhifenshu'}"> 止分数  </th>
...
<td> ${Info.subStr(map.addtime , 19 , "")} </td>
                            ...
                            <td align="center">
                                                                        ...
                                                                        <a href="pingcejianyi_updt.do?id=${map.id}">编辑</a>
                                                                        <a href="pingcejianyi_delete.do?id=${map.id}" onclick="return confirm('确定要删除？')">删除</a>
                                                                <!--qiatnalijne-->
                            </td>
                        </tr>
                        </c:forEach>
