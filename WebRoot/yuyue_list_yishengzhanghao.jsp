...
<div class="layui-tab layui-tab-card">
    ...
    <div class="layui-tab-content">
        ...
        预约类型
                                ...
                                <select class="layui-select class_yuyueleixing2" data-value="${param.yuyueleixing}" data-rule-required="true" data-msg-required="请填写预约类型" id="yuyueleixing" name="yuyueleixing">
<option value="">请选择</option><option value="在线沟通">在线沟通</option>
<option value="线下沟通">线下沟通</option>

</select>
<script>
$(".class_yuyueleixing2").val($(".class_yuyueleixing2").attr("data-value"))</script>
