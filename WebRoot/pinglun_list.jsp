...
<div class="layui-tab layui-tab-card">
    ...
    <div class="layui-tab-content">
        ...
        标题
                                ...
                                <input type="text" class="layui-input" style="" name="biaoti" value="${param.biaoti}"/>                            
    </div>
                                                                                                    <div class="layui-form-item">
        回复内容
        
                                <input type="text" class="layui-input" id="huifuneirong" name="huifuneirong" value="${param.huifuneirong}"/>
    </div>
                                                                            <div class="layui-form-item">
        评论人
        
                                <input type="text" class="layui-input" style="" name="pinglunren" value="${param.pinglunren}"/>                            
    </div>
    ...
    搜索
                    ...
                    <table width="100%" border="1" lay-filter="table" id="tables" class="table layui-table">
                        ...
                        <tr align="center">
                            ...
                            <th lay-data="{field:'biaoti'}"> 标题  </th>
<th lay-data="{field:'faburen'}"> 发布人  </th>
<th lay-data="{field:'huifuneirong'}"> 回复内容  </th>
<th lay-data="{field:'pinglunren'}"> 评论人  </th>
