                ...
                <div class="pa10 form-search">
                    <form class="layui-form layui-form-inline" id="formSearch" action="?">
                        ...
                        <div class="layui-form-item">
                            ...
                            <select class="layui-select class_yuyueleixing1" data-value="${param.yuyueleixing}"
                                    data-rule-required="true" data-msg-required="请填写预约类型" id="yuyueleixing"
                                    name="yuyueleixing">
                            ...
                            <script>
                                $(".class_yuyueleixing1").val($(".class_yuyueleixing1").attr("data-value"))</script>
                ...
                <div class="list-table">
                    <table width="100%" border="1" lay-filter="table" id="tables" class="table layui-table">
                        ...
                        <tr align="center">
                            ...
                            <th lay-data="{field:'yuyuerenxingming'}"> 预约人姓名</th>
                            <th lay-data="{field:'lianxidianhua'}"> 联系电话</th>
                            <th lay-data="{field:'zhuangtai'}"> 状态</th>
                        ...
                        <c:set var="i" value="0"/><c:forEach items="${list}" var="map"><c:set var="i" value="${i+1}"/>
                            <tr id="${map.id}" pid="">
                                ...
                                <td align="center">
                                    ...
                                    <a href="yuyuequeren_add.do?id=${map.id}">添加预约确认</a>
                                    <a href="yuyuequeren_list.do?yuyueid=${map.id}">查询预约确认</a><br>
