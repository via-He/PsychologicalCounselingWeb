...
<div class="layui-tab layui-tab-card">
    ...
    <div class="layui-tab-content">
        ...
        分类名称
                                ...
                                <input type="text" class="layui-input" style="" name="fenleimingcheng" value="${param.fenleimingcheng}"/>                            
    </div>
    ...
    搜索
                    ...
                    <table width="100%" border="1" lay-filter="table" id="tables" class="table layui-table">
                        ...
                        <tr align="center">
                            ...
                            <th lay-data="{field:'fenleimingcheng'}"> 分类名称  </th>
                        ...
                        <tr id="${map.id}" pid="">
                            ...
                            <td align="center">
                                                                        ...
                                                                        <a href="wenzhangfenlei_updt.do?id=${map.id}">编辑</a>
                                                                        <a href="wenzhangfenlei_delete.do?id=${map.id}" onclick="return confirm('确定要删除？')">删除</a>
                                                                <!--qiatnalijne-->
                            </td>
                        </tr>
                        </c:forEach>
