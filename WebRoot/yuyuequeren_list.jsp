                ...
                <div class="pa10 form-search">
                    <form class="layui-form layui-form-inline" id="formSearch" action="?">
                        ...
                        <div class="layui-form-item">
                            ...
                            <select class="layui-select class_yuyueleixing22" data-value="${param.yuyueleixing}"
                                    id="yuyueleixing" name="yuyueleixing">
                            ...
                            <script>
                                $(".class_yuyueleixing22").val($(".class_yuyueleixing22").attr("data-value"))</script>
                        ...
                        <c:set var="i" value="0"/><c:forEach items="${list}" var="map"><c:set var="i" value="${i+1}"/>
                            <tr id="${map.id}" pid="">
                                ...
                                <td align="center">
                                    ...
                                    <a href="yuyuequeren_delete.do?id=${map.id}"
