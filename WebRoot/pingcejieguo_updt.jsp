...
<div class="layui-tab layui-tab-card">
    <ul class="layui-tab-title">
        <li class="layui-this">评测结果编辑评测结果:</li>
    </ul>
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form class="layui-form layui-input-form" action="pingcejieguoupdate.do" method="post" name="form1" id="form1">
    ...
    <div class="layui-input-block">
                                                    ...
                                                    <input type="text" class="layui-input" placeholder="输入总得分" style="width:150px;" id="zongdefen" name="zongdefen" value="${Info.html(mmm.zongdefen)}"/>                                            
    </div>
</div>
                                                        <div class="layui-form-item">
    ...
    <div class="layui-input-block">
                                                    ...
                                                    <textarea id="zhuanyejianyi" name="zhuanyejianyi" style="max-width: 750px;width:100%; height: 300px;">${Info.html(mmm.zhuanyejianyi)}</textarea><script>
            (function(){
    ...
    <div class="layui-input-block">
                                                    ...
                                                    <input type="text" class="layui-input" placeholder="输入测试者" style="width:150px;" readonly="readonly" id="ceshizhe" name="ceshizhe" value="${mmm.ceshizhe}"/>                                            
    </div>
</div>
                                                    <div class="layui-form-item">
