                ...
                <div class="list-table">
                    <table width="100%" border="1" lay-filter="table" id="tables" class="table layui-table">
                        ...
                        <tr align="center">
                            ...
                            <th lay-data="{field:'liuyanneirong'}"> 留言内容</th>
                            <th lay-data="{field:'faqiren'}"> 发起人</th>
                        ...
                        <c:set var="i" value="0"/><c:forEach items="${list}" var="map"><c:set var="i" value="${i+1}"/>
                            <tr id="${map.id}" pid="">
                                ...
                                <td align="center">
                                    ...
                                    <a href="xinxi_add.do?id=${map.id}">添加信息</a>
                                    <a href="xinxi_list.do?liuyanid=${map.id}">查询信息</a>
                                    <a href="liuyan_updt.do?id=${map.id}">编辑</a>
                                    <a href="liuyan_delete.do?id=${map.id}" onclick="return confirm('确定要删除？')">删除</a>
                                    <!--qiatnalijne-->
                                </td>
                            </tr>
                        </c:forEach>
