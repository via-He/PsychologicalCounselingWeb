...
<div class="layui-tab layui-tab-card">
    <ul class="layui-tab-title">
        <li class="layui-this">心理测评编辑心理测评:</li>
    </ul>
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form class="layui-form layui-input-form" action="xinlicepingupdate.do" method="post" name="form1" id="form1">
    
                                                        <div class="layui-form-item">
    <label class="layui-form-label">测评主题</label>
    <div class="layui-input-block">
        
                                                    <input type="text" class="layui-input" placeholder="输入测评主题" style="width:250px;" id="cepingzhuti" name="cepingzhuti" value="${Info.html(mmm.cepingzhuti)}"/>                                            
    </div>
</div>
                                                        <div class="layui-form-item">
    ...
    <div class="layui-input-block">
                                                    ...
                                                    <textarea id="cepingjieshao" name="cepingjieshao" style="max-width: 750px;width:100%; height: 300px;">${Info.html(mmm.cepingjieshao)}</textarea><script>
            (function(){
