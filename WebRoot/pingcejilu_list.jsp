...
<th lay-data="{field:'defen'}"> 得分  </th>
<th lay-data="{field:'daan'}"> 答案  </th>
<th lay-data="{field:'tijiaoren'}"> 提交人  </th>
<th lay-data="{field:'zimu'}"> 字母  </th>
...
<td> ${Info.subStr(map.addtime , 19 , "")} </td>
                            ...
                            <td align="center">
                                                                        ...
                                                                        <a href="pingcejilu_delete.do?id=${map.id}" onclick="return confirm('确定要删除？')">删除</a>
                                                                <!--qiatnalijne-->
                            </td>
                        </tr>
                        </c:forEach>
