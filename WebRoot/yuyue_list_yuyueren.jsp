...
<div class="layui-tab layui-tab-card">
    ...
    <div class="layui-tab-content">
        ...
        预约类型
                                ...
                                <select class="layui-select class_yuyueleixing3" data-value="${param.yuyueleixing}" data-rule-required="true" data-msg-required="请填写预约类型" id="yuyueleixing" name="yuyueleixing">
<option value="">请选择</option><option value="在线沟通">在线沟通</option>
<option value="线下沟通">线下沟通</option>

</select>
<script>
$(".class_yuyueleixing3").val($(".class_yuyueleixing3").attr("data-value"))</script>
...
<td> ${Info.subStr(map.addtime , 19 , "")} </td>
                            ...
                            <td align="center">
                                                                        ...
                                                                        <a href="yuyuequeren_list.do?yuyueid=${map.id}">查询预约确认</a>
