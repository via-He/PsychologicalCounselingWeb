                ...
                <div class="pa10 form-search">
                    <form class="layui-form layui-form-inline" id="formSearch" action="?">
                        ...
                        <div class="layui-form-item">
                            ...
                            <input type="text" class="layui-input" style="" name="cepingzhuti"
                                   value="${param.cepingzhuti}"/>
                        </div>
                        ...
                        <c:set var="i" value="0"/><c:forEach items="${list}" var="map"><c:set var="i" value="${i+1}"/>
                            <tr id="${map.id}" pid="">
                                ...
                                <td align="center">
                                    ...
                                    <a href="timu_add.do?id=${map.id}">添加测试题目</a>
                                    <a href="timu_list.do?xinlicepingid=${map.id}">测试题目查询</a>
<br>
                                    <a href="pingcejianyi_add.do?id=${map.id}">添加结果建议</a>
                                    <a href="pingcejianyi_list.do?xinlicepingid=${map.id}">结果建议查询</a>

                                    <br>
                                    <a href="xinliceping_detail.do?id=${map.id}">详情</a>
                                    <a href="xinliceping_updt.do?id=${map.id}">编辑</a>
                                    <a href="xinliceping_delete.do?id=${map.id}"
