...
<div class="layui-tab layui-tab-card">
    ...
    <div class="layui-input-block">
                                                    ...
                                                    <select class="layui-select class_yuyueleixing6" data-value="在线沟通" data-rule-required="true" data-msg-required="请填写预约类型" id="yuyueleixing" name="yuyueleixing" style="width:250px">
<option value="在线沟通">在线沟通</option>
<option value="线下沟通">线下沟通</option>

</select>
<script>
$(".class_yuyueleixing6").val($(".class_yuyueleixing6").attr("data-value"))</script>
