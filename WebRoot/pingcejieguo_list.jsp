...
<th lay-data="{field:'zongdefen'}"> 总得分  </th>
<th lay-data="{field:'ceshizhe'}"> 测试者  </th>
...
<td> ${Info.subStr(map.addtime , 19 , "")} </td>
                            ...
                            <td align="center">
                                                                        ...
                                                                        <a href="pingcejieguo_detail.do?id=${map.id}">详情</a>
                                                                        <a href="pingcejieguo_delete.do?id=${map.id}" onclick="return confirm('确定要删除？')">删除</a>
                                                                <!--qiatnalijne-->
                            </td>
                        </tr>
                        </c:forEach>
