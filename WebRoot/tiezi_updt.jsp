...
<div class="layui-tab layui-tab-card">
    <ul class="layui-tab-title">
        <li class="layui-this">情感驿站帖子编辑情感驿站帖子:</li>
    </ul>
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form class="layui-form layui-input-form" action="tieziupdate.do" method="post" name="form1" id="form1">
    
                                                        <div class="layui-form-item">
    <label class="layui-form-label">标题</label>
    <div class="layui-input-block">
        
                                                    <input type="text" class="layui-input" placeholder="输入标题" style="width:250px;" data-rule-required="true" data-msg-required="请填写标题" id="biaoti" name="biaoti" value="${Info.html(mmm.biaoti)}"/>                                            
    </div>
</div>
                                                        <div class="layui-form-item">
    ...
    <div class="layui-input-block">
                                                    ...
                                                    <div class="layui-input-group" style="width:250px">
    <input type="text" class="layui-input" id="tupian" name="tupian" value="${Info.html(mmm.tupian)}"/>
    ...
    <div class="layui-input-block">
                                                    ...
                                                    <input type="text" class="layui-input" placeholder="输入发布人" style="width:150px;" readonly="readonly" id="faburen" name="faburen" value="${mmm.faburen}"/>                                            
    </div>
</div>
                                                    <div class="layui-form-item">
